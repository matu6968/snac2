...
Whether the project might get picked up again by another developer might be a guess (it's unlikely as it was written by AI though) but for now goodbye for the ESP32 port, below is the original readme of the project:
